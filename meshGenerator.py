...
class MeshGenerator:
    ...
    def circle_points(self, rectangle_corners, rayon, mesh_parameters):
        """
        Génère un maillage pour la géométrie d'un cercle dans un rectangle.
        ...
        gmsh.model.add("Circle")  # Name
        # # Points of the geometry
        circle_center = [(rectangle_corners[0][0]+rectangle_corners[1][0])/2.0, (rectangle_corners[0][1]+rectangle_corners[3][1])/2.0]

        if 'lc_rectangle' in mesh_parameters:
            lc_rect = mesh_parameters['lc_rectangle']
            lc_circ = mesh_parameters['lc_circle']

            gmsh.model.geo.addPoint(rectangle_corners[2][0], rectangle_corners[2][1], 0.0, lc_rect, 1)  # Pt1
            gmsh.model.geo.addPoint(rectangle_corners[3][0], rectangle_corners[3][1], 0.0, lc_rect, 2)  # Pt2
            gmsh.model.geo.addPoint(rectangle_corners[0][0], rectangle_corners[0][1], 0.0, lc_rect, 3)  # Pt3
            gmsh.model.geo.addPoint(rectangle_corners[1][0], rectangle_corners[1][1], 0.0, lc_rect, 4)  # Pt4
            gmsh.model.geo.addPoint(circle_center[0],       circle_center[1],       0.0, lc_circ, 5)  # Pt5
            gmsh.model.geo.addPoint(circle_center[0]+rayon, circle_center[1],       0.0, lc_circ, 6)  # Pt6
            gmsh.model.geo.addPoint(circle_center[0],       circle_center[1]+rayon, 0.0, lc_circ, 7)  # Pt7
            gmsh.model.geo.addPoint(circle_center[0]-rayon, circle_center[1],       0.0, lc_circ, 8)  # Pt8
            ...
            cospi4 = np.cos(np.pi/4)
            length_min = min(rectangle_corners[1][0]-rectangle_corners[0][0], rectangle_corners[3][1]-rectangle_corners[0][1])
            rext = max(min(3*rayon, 0.75*length_min/2.), 1.5*rayon)
            gmsh.model.geo.addPoint(rectangle_corners[0][0], rectangle_corners[3][1], 0.0, 0.0, 1)  # Pt1
            gmsh.model.geo.addPoint(rectangle_corners[0][0], rectangle_corners[0][1], 0.0, 0.0, 2)  # Pt2
            gmsh.model.geo.addPoint(rectangle_corners[1][0], rectangle_corners[0][1], 0.0, 0.0, 3)  # Pt3
            gmsh.model.geo.addPoint(rectangle_corners[1][0], rectangle_corners[3][1], 0.0, 0.0, 4)  # Pt4
            ...
            gmsh.model.geo.addPoint(circle_center[0]+rext*cospi4, rectangle_corners[0][1], 0.0, 0.0, 14)  # Pt14
            gmsh.model.geo.addPoint(circle_center[0]-rext*cospi4, rectangle_corners[0][1], 0.0, 0.0, 15)  # Pt15
            gmsh.model.geo.addPoint(circle_center[0]+rext*cospi4, rectangle_corners[3][1], 0.0, 0.0, 16)  # Pt16
            gmsh.model.geo.addPoint(circle_center[0]-rext*cospi4, rectangle_corners[3][1], 0.0, 0.0, 17)  # Pt17

            gmsh.model.geo.addPoint(rectangle_corners[0][0], circle_center[1]+rext*cospi4, 0.0, 0.0, 18)  # Pt18
            gmsh.model.geo.addPoint(rectangle_corners[0][0], circle_center[1]-rext*cospi4, 0.0, 0.0, 19)  # Pt19
            gmsh.model.geo.addPoint(rectangle_corners[1][0], circle_center[1]+rext*cospi4, 0.0, 0.0, 20)  # Pt20
            gmsh.model.geo.addPoint(rectangle_corners[1][0], circle_center[1]-rext*cospi4, 0.0, 0.0, 21)  # Pt21
